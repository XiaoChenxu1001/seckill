...
//                if (cookieList[i].getName().equals(cookieName)) {
                ...
                String path = cookieList[i].getPath();
                if (name.equals(cookieName)) {//&&  "/".equals(path)
                    if (isDecoder) {
    ...
    public static void setCookie(HttpServletRequest request, HttpServletResponse response, String cookieName,
                                 String cookieValue) {
        System.out.println("setCookie: " + request.getPathInfo() + " : " + cookieName + " " + cookieValue);
